  ...
  <header className="sticky top-0 z-50 border-b border-[var(--border)] bg-[var(--navbar)]">
    <div className="flex h-20 w-full items-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="hidden flex-1 justify-center min-[780px]:flex">
        <nav className="flex items-center rounded-full border border-[var(--border)] bg-[var(--surface-secondary)] p-2 shadow-sm">
      ...
      <div className="ml-auto flex shrink-0 items-center gap-1.5 min-[780px]:gap-2">
        {showSearch ? (
          <div className="hidden items-center rounded-full border border-[var(--border)] bg-[var(--surface-secondary)] px-4 shadow-sm min-[780px]:flex">
            <Search
              size={18}
          ...
          <button
            ...
            className="hidden h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[var(--border)] bg-[var(--surface-secondary)] text-[var(--text-secondary)] shadow-sm transition hover:border-[var(--border-hover)] hover:bg-[var(--surface)] dark:hover:text-[var(--primary-hover)] min-[780px]:flex"
          >
            <Search size={18} />
          </button>
        )}
        ...
        <button
          ...
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[var(--border)] bg-[var(--button-secondary)] text-[var(--text-secondary)] shadow-sm transition hover:border-[var(--border-hover)] hover:bg-[var(--surface)] dark:hover:text-[var(--primary-hover)]"
        >
          {theme === "dark" ? (
            <Sun size={18} />
          ) : (
        ...
        <Link
          to="/wishlist"
          aria-label="Wishlist"
          className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[var(--border)] bg-[var(--surface-secondary)] text-[var(--text-secondary)] shadow-sm transition hover:border-[var(--border-hover)] hover:bg-[var(--surface)] dark:hover:text-[var(--primary-hover)]"
        >
          <Heart size={18} />
        ...
        {user ? (
          <Link
            to="/profile"
            className="hidden h-11 items-center gap-2 rounded-full border border-[var(--border)] bg-[var(--surface-secondary)] px-4 text-sm font-semibold text-[var(--text-secondary)] shadow-sm transition hover:bg-[var(--surface)] hover:text-[var(--primary)] min-[780px]:flex"
          >
            <UserRound size={18} />
            {userLabel}
          </Link>
    ...
    {isMenuOpen && (
      <div className="border-t border-[var(--border)] bg-[var(--navbar)] px-4 py-4 min-[780px]:hidden">
