  ...
  return (
    <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-sm transition-colors duration-300">
      <div className="flex flex-col sm:flex-row sm:text-left gap-4 mb-6">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[var(--text)] transition-colors duration-300 transition-colors duration-300">{displayName}</h2>
          <p className="text-sm text-[var(--text-darker)] opacity-90 transition-colors duration-300 transition-colors duration-300">{userData?.email}</p>
          <span className="text-xs font-semibold text-[var(--primary)] transition-colors duration-300 transition-colors duration-300">{userData?.role||"Customer"}</span>
        </div>
      </div>
      {!isEditing ? (
        <>
          ...
          className="mt-4 rounded-lg border border-[var(--primary)] px-4 py-2 text-sm font-semibold text-[var(--primary)] transition hover:bg-[var(--primary)] hover:text-[var(--text-inverse)] transition-colors duration-300">
            Edit Profile </button>
        </>
